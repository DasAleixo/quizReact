    ...
    <div  className="flex flex-col">
        ...
        <div className="flex justify-center items-center">
            {quizState.questions.map((question) => (
                <button onClick={() => chooseCategory(question.category)} key={question.category} className="border-2 border-white bg-gradient-to-r from-violet-500 text-white py-2 px-5 font-bold text-xl rounded-3xl shadow-xl mb-8 hover:from-violet-400 transition-colors mr-10">{question.category}</button>
            ))}
        </div>
